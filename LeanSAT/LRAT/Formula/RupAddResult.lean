...
theorem derivedLits_nodup {n : Nat} (f : DefaultFormula n) (f_assignments_size : f.assignments.size = n) (rupHints : Array Nat)
  ...
  . by_cases k.1 = i.1
    ...
    . next k_ne_i =>
      ...
      simp only [getElem_fin, derivedLits_arr_def, ne_eq, Array.getElem_eq_data_get] at h3
  . by_cases li.2 = true
    . next li_eq_true =>
      ...
      . next i_ne_k1 =>
        ...
        simp only [getElem_fin, Array.getElem_eq_data_get, ne_eq, derivedLits_arr_def] at h3
    . next li_eq_false =>
